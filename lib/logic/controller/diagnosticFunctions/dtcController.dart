...
//   (x) {
//     print("      🔍 Comparing GD DTC CODE: ${x.code?.code} with Selected CODE: ${selectedDtc.code}");
...
//    final loader = CommonLoader(message: "Loading...");
...
//   try {
//     emptyViewText.value = "Loading...";
//     print("🔹 Starting getDtc for ECU: ${dtcEcusModel.ecuName}");

//     // Ensure dtcList is not null
//     dtcEcusModel.dtcList ??= [];
//     dtcEcusModel.dtcList!.clear();
//     print("🔹 Cleared dtcList, current length: ${dtcEcusModel.dtcList!.length}");

//     // Check protocol
//     if (dtcEcusModel.protocol == null) {
//       print("❌ Protocol is null for ECU: ${dtcEcusModel.ecuName}");
//     } else {
//       print("🔹 Protocol: ${dtcEcusModel.protocol!.autopeepal}");
//     }
...
//     );
//     print(
//         "🔹 Dongle properties set (TX: ${dtcEcusModel.txHeader}, RX: ${dtcEcusModel.rxHeader})");

//     // Check readDtcIndex
//     if (ecu.readDtcIndex == null || ecu.readDtcIndex!.isEmpty) {
//       print("❌ readDtcIndex is null or empty for ECU: ${dtcEcusModel.ecuName}");
//     } else {
//       print("🔹 readDtcIndex: ${ecu.readDtcIndex}");
//     }

//     // Read DTCs
//     ReadDtcResponseModel? readDtcResponse =
//         await App.dllFunctions!.readDtc(ecu.readDtcIndex ?? '');
//     print("🔹 readDtcResponse received: ${readDtcResponse != null}");
...
//       for (int i = 0; i < codeLength; i++) {
//         try {
//           var rawDtc = readDtcResponse.dtcs![i];
//           print("  🔹 Raw DTC at index $i: $rawDtc");

//           String code = rawDtc[0].toString();
//           String dtcStatus = rawDtc[1].toString();
//           print("    ➤ Parsed code: $code, status: $dtcStatus");
...
//               break;
//             default:
//               dtcListModel.statusActivationColor = Colors.grey;
//           }

//           // Map description from server list
//           print("    ➤ Mapping description from dtcServerList...");
//           var desc = dtcServerList.firstWhere(
//             (x) => x.code == dtcListModel.code,
//             orElse: () => DtcCode(description: "Description not found"),
//           );
//           dtcListModel.description = desc.description;
//           dtcListModel.id = desc.id;
//           print("    ➤ Description mapped: ${dtcListModel.description}");

//           // Filter by status
//           if (dtcListModel.statusActivation == "Active" ||
//               dtcListModel.statusActivation == "Inactive") {
//             dummyList.add(dtcListModel);
//             print("    ➤ Added to dummyList");
//           } else {
//             print("    ➤ Skipped due to status: ${dtcListModel.statusActivation}");
//           }
//         } catch (e, s) {
//           print("⚠️ Exception processing DTC index $i: $e");
//           print(s);
...
//       // Remove duplicates
//       print("🔹 Removing duplicates from dummyList...");
//       var distinctItems = {for (var e in dummyList) e.code: e}.values.toList();
//       print("🔹 Distinct DTC count: ${distinctItems.length}");
...
//           statusActivationColor: x.statusActivationColor,
//         ));
//         print("  ✅ Added DTC: ${x.code} - ${x.description}");
//       }

//       if (dtcEcusModel.dtcList!.isEmpty) {
//         print("⚠️ dtcList is empty after processing");
//         emptyViewText.value = "No DTCs found";
//       }

//     } else {
//       print("❌ readDtcResponse is null for ECU: ${dtcEcusModel.ecuName}");
//       emptyViewText.value = "ECU_COMMUNICATION_ERROR";
//     }

//     print(
//         "🔹 Finished getDtc for ECU: ${dtcEcusModel.ecuName}, final DTC count: ${dtcEcusModel.dtcList!.length}");
//     return dtcEcusModel;
//   } catch (e, s) {
//     print("❌ Exception in getDtc: $e");
//     print(s);
